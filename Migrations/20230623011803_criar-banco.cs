        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Formacao_disciplina_DisciplinaId",
                        column: x => x.DisciplinaId,
                        principalTable: "disciplina",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Formacao_Professor_ProfessorId",
                        column: x => x.ProfessorId,
                        principalTable: "Professor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Atribuicao_GradeDisciplinas_GradeDisciplinasId",
                        column: x => x.GradeDisciplinasId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "14b01c06-a39b-48f4-b9ea-fe18b286cb6c", "e35aba25-7eea-4403-947e-0a24adb0dd84", "Administrador", "ADMINISTRADOR" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "2c227783-11a4-4710-a2a3-edb6d57e4365", "0e1e7806-48f6-4c95-8cb0-2f9bbb8bced8", "Professor", "PROFESSOR" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Atribuicao_GradeDisciplinasId",
                table: "Atribuicao",
                column: "GradeDisciplinasId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Formacao_DisciplinaId",
                table: "Formacao",
                column: "DisciplinaId");

            migrationBuilder.CreateIndex(
                name: "IX_Formacao_ProfessorId",
                table: "Formacao",
                column: "ProfessorId");
